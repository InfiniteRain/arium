...
fn compileStmt(self: *Compiler, stmt: Air.Index, value_usage: ValueUsage) Error!void {
...
fn compileFnExpr(self: *Compiler, air_fn: Air.Key.Fn, loc: Span(u8)) Error!void {
    const fn_index = try self.compileFn(air_fn, loc);

    try self.writeConstant(.{ .@"fn" = fn_index }, loc);
}

fn compileFn(self: *Compiler, air_fn: Air.Key.Fn, loc: Span(u8)) Error!u64 {
...
fn compileExpr(self: *Compiler, air_expr: Air.Index, value_usage: ValueUsage) Error!void {
...
fn compileUnaryExpr(self: *Compiler, air_key: Air.Key, loc: Span(u8)) Error!void {
...
fn compileBlockExpr(self: *Compiler, block: []const Air.Index, value_usage: ValueUsage) Error!void {
...
fn compileReturnExpr(self: *Compiler, @"return": Air.Index, loc: Span(u8)) Error!void {
...
fn writeU8(self: *Compiler, data: anytype, loc: Span(u8)) Allocator.Error!void {
...
fn writeU16(self: *Compiler, data: u16, loc: Span(u8)) Allocator.Error!void {
...
fn writeConstant(self: *Compiler, constant_value: ConstantValue, loc: Span(u8)) Error!void {
...
fn writeJump(self: *Compiler, op_code: OpCode, loc: Span(u8)) Error!usize {
    try self.writeU8(op_code, loc);
...
fn writeNegativeJump(self: *Compiler, offset: usize, loc: Span(u8)) Error!void {
...
fn patchJumps(self: *Compiler, jumps: []const usize) Error!void {
    for (jumps) |jump| {
        try self.patchJump(jump);
    }
}

fn compilerError(self: *Compiler, diag: Diags.Entry.Tag, loc: Span(u8)) Error {
